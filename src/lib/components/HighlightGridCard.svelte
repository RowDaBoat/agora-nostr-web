...
<div class="group relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-primary/10 hover:from-primary/20 hover:via-primary/10 hover:to-primary/20 transition-all duration-300 cursor-pointer border border-border">
  <!-- Highlight marker on the left -->
  <div class="absolute left-0 top-0 bottom-0 w-2 bg-gradient-to-b from-primary/60 via-primary to-primary/80" />
  ...
  <div class="relative h-full p-5 flex flex-col">
    ...
    <div class="flex-1 mb-4 overflow-hidden">
      <div class="relative">
        <!-- Large opening quote -->
        <span class="absolute -top-2 -left-1 text-5xl text-primary/30 font-serif leading-none">"</span>
    ...
    <div class="flex items-center gap-2 mt-auto pt-3 border-t border-primary/20">
  ...
  <!-- Hover overlay -->
  <div class="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
</div>
