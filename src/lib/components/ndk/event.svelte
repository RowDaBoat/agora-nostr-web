...
<script lang="ts">
  ...
  import ArticlePreview from '../../cards/preview/article-preview/article-preview.svelte';
  import NotePreview from '../../cards/preview/note-preview/note-preview.svelte';
  import GenericPreview from '../../cards/preview/generic-preview/generic-preview.svelte';
