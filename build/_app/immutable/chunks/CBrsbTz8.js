import{D as i,a0 as a}from"./CSbKtK4P.js";function c(n){if(i){const e=new Error(`lifecycle_outside_component
...
https://svelte.dev/e/lifecycle_function_unavailable`);throw e.name="Svelte error",e}var t=null;function d(n){t=n}function h(){const n={};return[()=>s(n),e=>u(n,e)]}function s(n){return o("getContext").get(n)}function u(n,e){return o("setContext").set(n,e),e}function m(n){return o("hasContext").has(n)}function w(){return o("getAllContexts")}function o(n){return t===null&&c(n),t.c??=new Map(f(t)||void 0)}function x(n){t={p:t,c:null,r:null},i&&(t.function=n,t.element=t.p?.element)}function g(){t=t.p}function f(n){let e=n.p;for(;e!==null;){const r=e.c;if(r!==null)return r;e=e.p}return null}let l=null;function y(){l?.abort(a),l=null}function C(){return(l??=new AbortController).signal}export{t as a,p as b,g as c,y as d,u as e,h as f,s as g,C as h,w as i,m as j,v as l,x as p,d as s};
